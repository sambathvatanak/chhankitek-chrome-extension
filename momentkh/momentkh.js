...
;(function (global, factory) {
  ...
  function formatKhmerDate({day, month, moment}, format) {
    if (format === null || format === undefined) {
      ...
      return config.postformat(`ថ្ងៃ${config.weekdays[dayOfWeek]} ${moonDay.count}${config.moonStatus[moonDay.moonStatus]} ខែ${config.lunarMonths[month]} ឆ្នាំ${config.animalYear[animalYear]} ${config.eraYear[eraYear]} ព.ស ${beYear}`);
